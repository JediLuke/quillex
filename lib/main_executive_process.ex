# defmodule QuillEx.MainExecutiveProcess do
#     @moduledoc """
#     Coordinates & administrates all the functionality of QuillEx.
#     """
#     use GenServer
...
#       :ok = QuillEx.Utils.PubSub.register(topic: "action_events") # be notified of `actions` fired internally
#       {:ok, init_state}
#     end

#     def handle_call(:init_default_gui_scene, state) do
      
#     end

#     def handle_info({:action, a}, state) do
      
#       IO.puts "MEP msg received #{inspect a}"
#       {:noreply, state}
#     end
...
#     #   # Flamelex.Utils.PubSub.subscribe(event_bus: :actions) # be notified of `actions` fired internally - alternative proposal !?
