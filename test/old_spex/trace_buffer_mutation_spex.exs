    ...
    scenario "Trace buffer during up arrow movement", context do
      given_ "three lines of text", context do
        ...
        if buf_state do
          ...
          IO.inspect(buf_state.cursor, label: "cursor")
        end
      ...
      when_ "moving cursor and inserting text", context do
        ...
        if buf_state1 do
          ...
          IO.puts("   Cursor: #{inspect(buf_state1.cursor)}")
        end
        ...
        if buf_state2 do
          ...
          IO.puts("   Cursor: #{inspect(buf_state2.cursor)}")
        end
        ...
        if buf_state4 do
          ...
          IO.puts("   Cursor: #{inspect(buf_state4.cursor)}")
        end
        ...
        if buf_state_final do
          ...
          IO.puts("   Final cursor: #{inspect(buf_state_final.cursor)}")
        end
